<script lang="ts">
    ...
    import MultiselectCategoryInput from '../MultiselectCategoryInput/MultiselectCategoryInput.svelte';
...
>
    ...
    {#if currentModal === 'title'}
        <div class="flex flex-col items-center gap-4">
            <p class="text-2xl text-cocoa font-bold">Wprowadź nazwę spotkania</p>
    ...
    {:else if currentModal === 'spot'}
        <div class="flex flex-col items-center gap-4">
            <p class="text-2xl text-cocoa font-bold">Wybierz dokładne miejsce</p>
            <div
    ...
    {:else if currentModal === 'datetime'}
        <div class="flex flex-col items-center gap-4">
            <p class="text-2xl text-cocoa font-bold">Wybierz datę spotkania</p>
            <div class="flex">
