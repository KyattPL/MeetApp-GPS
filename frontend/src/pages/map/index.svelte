...
<div class="h-screen">
    ...
    <div class="absolute z-[9999] p-4 flex flex-col bottom-4 right-4 bg-ivory text-cocoa rounded-xl border-pine border-2 gap-2">
        ...
        <div class="flex flex-row items-center gap-2 justify-between">
            ...
            <button
                class="rounded-full {areEventsOn
                    ? 'bg-grass'
                    : 'bg-gray'} border-pine border-2 h-12 w-12 lg:bottom-56 lg:h-20 lg:w-20 lg:right-20 z-[9999]"
        ...
        <div class="flex flex-row items-center gap-2 justify-between">
            <div class="text-lg font-bold">Spotkania</div>
            <button
                class="rounded-full {areMeetingsOn
                    ? 'bg-grass'
                    : 'bg-gray'} border-pine border-2 h-12 w-12 lg:bottom-32 lg:h-20 lg:w-20 lg:right-20 z-[9999]"
        ...
        <div class="flex flex-row items-center gap-2 justify-between">
            <div class="text-lg font-bold">Ogłoszenia</div>
            <button
                class="rounded-full {areAnnouncementsOn
                    ? 'bg-grass'
                    : 'bg-gray'} border-pine border-2 h-12 w-12 lg:bottom-8 lg:h-20 lg:w-20 lg:right-20 z-[9999]"
    ...
    <div class="absolute z-[9999] p-4 flex flex-col bottom-4 left-4 bg-ivory text-cocoa rounded-xl border-pine border-2 gap-2">
