<script lang="ts">
    ...
    const submitChanges = () => {
        ...
        }).then((r) => (window.location.href = 'http://meetapp-ux.northeurope.cloudapp.azure.com:8080'));
    };
...
{#await waitForUser() then _}
    <div class="flex flex-col bg-ivory h-screen justify-between lg:w-1/3 lg:mx-auto lg:py-10">
        ...
        <div class="flex flex-col items-center">
            ...
            <button on:click={() => (window.location.href = 'http://meetapp-ux.northeurope.cloudapp.azure.com:8080/')}>
