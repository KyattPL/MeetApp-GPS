<script lang="ts">
    ...
    const handleSubmit = () => {
        if (
            ...
            $selectedLongitude = 0;
            $selectedLatitude = 0;
            execute('meetings', 'POST', requestBody).then((r) => (window.location.href = 'http://localhost:8080/meetings'));
        }
    };
...
<div class="h-screen">
    ...
    <div class="flex flex-row justify-center">
        <div class="flex mt-8 flex-col gap-10">
            <InputHelpTooltip text="Wprowadź nazwę spotkania" />
            <InputHelpTooltip text="Wybierz kategorie" />
            <InputHelpTooltip text="Wybierz miasto" />
            <InputHelpTooltip text="Wybierz dokładne miejsce" style="!-mt-4" />
            <InputHelpTooltip text="Ustal datę spotkania" style="!-mt-4" />
            <InputHelpTooltip text="Ustal limit osób" style="!-mt-4" />
            ...
            <div class="w-full">
                ...
                <div class="bg-tea mx-1.5 my-4 p-2 rounded-lg">
                    ...
                    <div class="flex flex-row">
                        <div class="py-2 mr-0.5">
                            <PostDateInput bind:value={dateValue} />
                        </div>
                        <div class="py-2 ml-0.5">
